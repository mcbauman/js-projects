// Project
// ​
let str="Was du liebst, lass frei. Kommt es zurück, gehört es dir - für immer."
// String
...
function toHexadecimal(str){
    ...
    for(i=0;i<arr.length;i++){
        result.push(arr.toString(16))
    }
    return result
}
console.log(toHexadecimal("12"));
console.log("HERE",String.fromCharCode(12,100,1,0));
